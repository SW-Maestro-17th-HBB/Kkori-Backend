...
/**
 * {@code @Scheduled} 활성화 — SSE keepalive, 세션 수렴 스위퍼, 파기·RT 청소 배치(각 도메인의 {@code scheduler} 패키지).
 *
 ...
 *
 * <p>스케줄러 빈들(스위퍼 트리거 포함)은 {@code app.batch.enabled}(기본 true)로 등록을 끌 수 있다 — 통합 테스트가
