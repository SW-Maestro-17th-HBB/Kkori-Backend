...
class ResumeSseIntegrationTest {
    ...
    private void publishStatus(long resumeId, long userId, String status, String message) {
        redisTemplate.opsForStream().add(StreamRecords
                .mapBacked(new ResumeStatusChangedMessage(resumeId, userId, status, message).toMap())
